...
var extender = require('gulp-html-extend'); // HTML樣版語言
...
gulp.task('minify-html', function() {
  return gulp
    .src('./source/views/application/**/*.html')
...
gulp.task('sass', function() {
  ...
  return (
    gulp
      ...
      ) //有include Bootstrap-Sass、fontawesome
      //此時已編譯好 CSS
...
gulp.task('bower', function() {
  return gulp.src(mainBowerFiles()).pipe(gulp.dest('./.tmp/vendors')); //暫放在此資料夾
});
